        ...
        <View className='userDetails_falls_details' onClick={() =>{
          ...
          <View className='userDetails_falls_makebg'
            ...
            <View className='userDetails_share_accress'>
              ...
              <View className='userDetails_share_limit'>{GetDistance(lat,lnt,merchantLat,merchantLnt)+ ''} {merchantAddress || ''}  </View>
            </View>
          </View>
      ...
      <View className='perimerter_box'>
        ...
        {login(userInfo) !=='0' || Object.keys(userDetails).length<5?
          <View className='perimerter_noUser' onClick={() =>navigateTo('/pages/auth/index')}>
            ...
            <View className='perimerter_btn'>
              {filterLogin(login(userInfo))}
            </View>
          </View>
          :
          <View className='perimerter_card'>
            <View className='perimerter_userProfile'  onClick={() =>navigateTo('/pages/newUser/userDetails/index')} style={backgroundObj(profile)}></View>
            <View className='perimerter_userBox'>
              <View className='perimerter_userName'>
                <View className='perimerter_userflow font_hide'>
                  {username||'--'}
                </View>
                <View className={ classNames( 'user_user_iconBox',userRealNameStatus === '1' ?'perimerter_user_icon2':'perimerter_user_icon1')}>
        ...
        <View className='perimerter_active'>
          <View className='perimerter_beanActive'  onClick={() =>goDown()}>
            <View className='perimerter_dec'>
              <View className='perimerter_title'>打卡一条街</View>
              <View className='permerter_intertion permerter_interSize1'>龙湖天街</View>
          ...
          <View className='permerter_share'>
            <View className='permerter_share_look' onClick={() => navigateTo('/pages/index/lookShare/index')}>
              <View className='perimerter_dec'>
                <View className='perimerter_title'>看分享</View>
                <View className='permerter_intertion permerter_interSize2'>龙湖天街</View>
              </View>
            </View>
            <View className='permerter_share_game' onClick={() =>goDown()}>
              <View className='perimerter_dec'>
                <View className='perimerter_title'>卡豆乐园</View>
                <View className='permerter_intertion permerter_interSize2'>趣味挑战赛</View>
              </View>
            </View>
          </View>
        </View>
        <View className='permerter_tab'>
          <View className='permerter_tab_box'>
            <View className='permerter_tab_iconBox permerter_tab_icon1' onClick={() => navigateTo('/pages/newUser/record/index')}></View>
          ...
          <View className='permerter_tab_box'>
            <View className='permerter_tab_iconBox permerter_tab_icon3' onClick={() => navigateTo('/pages/share/shareShop/index')}></View>
            <View className='permerter_tab_font'>
              我要推店
            </View>
          </View>
        ...
        <View className='permerter_tab_kol'>
          <ScrollView
            ...
            { domainList.map((item,index) => {
              return (
                <View onClick={() =>this.setTicName(item,index)} key = {index} className= {classNames('permerter_kol_domain', selectIndex == index && 'checked')}>
                  {item.domainName}
                </View>
              )
            })}
            ...
            >
              {
                ...
                return (
                  item.topicId !== topicId ? <View onClick={() => this.setTopic(item)} className='tip_noCheck'>{item.topicName}</View>:
