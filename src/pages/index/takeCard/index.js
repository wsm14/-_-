...
import router from "../../../common/router";
import { NavHeight,getLat,getLnt } from "@/common/utils";
import Selects from "./components/select";
import Slider from "./components/silder";
import { createMerchantByMap } from "./components/template";
        ...
        selectResult: [
          {
            ...
            data: [
              { value: "", distance: "全部" },
              { value: "500", distance: "500m" },
              {
                value: "1000",
                distance: "1km",
              },
              { value: "2000", distance: "2km" },
              { value: "5000", distance: "5km" },
              {
                value: "10000",
                distance: "10km",
              },
          ...
          },
          {
            ...
            value: "value",
            data: [
              { filterType: "智能排序", value: "智能排序" },
              { filterType: "捡豆数量", value: "捡豆数量" },
              {
                filterType: "有优惠",
                value: "有优惠",
              },
              { filterType: "到店打卡", value: "到店打卡" },
              { filterType: "商家分享", value: "商家分享" },
            ],
          },
        ],
      });
    ...
    return (
      <View className="page_maps">
        ...
        <Selects
          ...
          list={selectResult}
          visible={true}
          onChange={(key, value) => this.setSelectTab(key, value)}
        ></Selects>
        ...
        <CoverView
          className="silder_btn color6 font32 bold"
          onClick={() => scanCode()}
        >
          <CoverView className="silder_btn_style">扫码打卡</CoverView>
          <CoverImage
            className="silder_btn_image"
            src={
              "https://dakale-wechat-new.oss-cn-hangzhou.aliyuncs.com/miniprogram/image/icon431.png"
            }
          ></CoverImage>
        </CoverView>
      </View>
