  ...
  render() {
    ...
    return (
      <View className='page_userBox'>
        {loginStatus === 0 &&
        <View className='page_userTop' onClick={() => navigateTo('/pages/auth/index')}>

          <View className='user_profiles dakale_profile'></View>

          <View className='user_details'>
            <View className='users_name color1 bold'>
              登录后玩转哒卡乐
            </View>
            <View className='user_card_dec font24'>
              打卡，记录美好生活
            </View>
          </View>
        ...
        {
          loginStatus !== 0 &&
          <View className='page_userTop' onClick={() => navigateTo('/pages/newUser/userDetails/index')}>
            <View className='user_profiles dakale_profile'
            ...
            <View className='user_details'>
              ...
              <View className='users_status'>
                <View
                  className={classNames('users_tag_box', realNameStatus === '2' ? 'user_tag_color2' : 'user_tag_color1')}>
                  <View
                    className={classNames('users_tag_iconBox', realNameStatus === '2' ? 'users_tag_icon2' : 'users_tag_icon1')}></View>
                  <View className='users_tag_font font20 color6'>
                    {realNameStatus === '2' ? '已认证' : '未认证'}
                  </View>
                </View>
                {
                  userLevelSign && level != '0' && <View className='user_tag_lever'>
        ...
        <View className='user_surplus user_beanBg'>
          <View className='user_surplus_title color6'>
            ...
            <View className='user_surplus_beanDec user_beanQuestion' onClick={(e) => {
              e.stopPropagation();
              navigateTo(
          ...
          <View onClick={() => navigateTo('/pages/newUser/wallet/index')} className='user_surplus_center'>
            ...
            <View className='user_surplus_box'>
              <View className='user_surplus_dayStyle font24 color2'>今日收益</View>
            ...
            <View className='user_surplus_box'>
              <View className='user_surplus_dayStyle font24 color2'>本月收益</View>
              <View className='user_surplus_num color1 font36 bold'>{monthEarn || '0'}</View>
            </View>
          </View>
        </View>
        <Tab1></Tab1>
        ...
        <View className='users_actives'>
          <Image
            onClick={() => navigateTo(`/pages/share/webView/index?link=${link}&title=哒卡乐诚邀商家入驻`)}
            src={'https://dakale-wechat-new.oss-cn-hangzhou.aliyuncs.com/miniprogram/image/icon313.png'}
            lazyLoad
        ...
        <View className='users_ourSetting'>
          ...
          <View className='users_ourSetting_bg'>
            <View className='users_setting_bg public_auto'>
              {list.map(item => {
                return (
                  <View className='users_set_box' onClick={() => item.fn && item.fn()}>
