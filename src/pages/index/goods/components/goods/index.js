...
export default (props) => {
  ...
  const createShopTop = (item, merchant) => {
    ...
    return (
      <View className='createGood_title' onClick={(e) => {
        e.stopPropagation();
  ...
  const createBottom = (item) => {
    ...
    const {merchantIdString, kolGoods = {}, specialGoods = {}} = (orderDesc && JSON.parse(orderDesc)) || {}
    if (orderType === 'kolGoods') {
      return {
          ...
          <View className='createGood_bottom'>
            <View className='createGood_btn_style'>
              ...
              <View className='createGood_btn_right createGood_btn_color1'
                    onClick={() => goPay(orderSn, orderType)}>去付款</View>
            </View>
          </View>
        ),
        '1': (<View className='createGood_bottom'>
          <View className='createGood_btn_style'>
            <View className='createGood_btn_left'>
            </View>
            <View className='createGood_btn_right createGood_btn_color1'
                  onClick={() => goGoodDetails(orderSn)}>去使用</View>
          </View>
        </View>),
        '2': (<View className='createGood_bottom'>
          <View className='createGood_btn_style'>
            <View className='createGood_btn_left'>
            </View>
            <View className='createGood_btn_right createGood_btn_color1'
                  onClick={() => goKolGoods(merchantIdString, kolGoods.activityIdString, kolMomentsIdString)}
            >
              再次购买
            </View>
          </View>
        </View>),
        '3': (<View className='createGood_bottom'>
          <View className='createGood_btn_style'>
            <View className='createGood_btn_left'>
            </View>
            <View
        ...
        '6': (<View className='createGood_bottom'>
          <View className='createGood_btn_style'>
            <View className='createGood_btn_left'>
      ...
      return {
        '0': (<View className='createGood_bottom'>
            <View className='createGood_btn_style'>
              <View className='createGood_btn_left'>
                待付款：<Text style={{color: 'rgba(51, 51, 51, 1)'}}>{<InterTime fn={() => updateStatus(item)}
                                                                             times={createTime}></InterTime>}</Text>
        ...
        '2': (<View className='createGood_bottom'>
          <View className='createGood_btn_style'>
            ...
            <View className='createGood_btn_right createGood_btn_color1'
                  onClick={() => goSpeGoods(merchantIdString, specialGoods.activityIdString)}>再次购买</View>
          </View>
        </View>),
        '3': (<View className='createGood_bottom'>
          <View className='createGood_btn_style'>
            ...
            <View className='createGood_btn_right createGood_btn_color1'
                  onClick={() => goSpeGoods(merchantIdString, specialGoods.activityIdString)}
            >
              重新购买
            </View>
          </View>
      ...
      <View className='createGood_box'>
        <View className='createGood_title' onClick={(e) => {
          ...
          <View className='createGood_title_box'>
            ...
            <View className='createGood_merchantName font_hide'>{merchantName}</View>
            <View className='createGood_merchantgo'></View>
            <View className='createGood_status status_color1'>已完成</View>
          </View>
        </View>
        <View className='createGood_content' onClick={() => goCodeDetails(orderSn)}>
  ...
  const createShopGoods = (item) => {
    ...
    const orderTypeObj = {
      kolGoods: (<View className='createGood_content'
                       onClick={() => goGoodDetails(orderSn)}>
        <View className='createdGood_details_box'>
          <View className='createdGood_details_image dakale_nullImage'
        ...
        <View className='createdGood_details_timeBox'>
          <View className='time_color2'>
            有效期至：{kolGoods.useStartTime} - {kolGoods.useEndTime}
          </View>
        </View>
      </View>),
      specialGoods: (<View className='createGood_content'
                           onClick={() => goGoodDetails(orderSn)}
      >
        <View className='createdGood_details_box'>
          <View className='createdGood_details_image dakale_nullImage'
        ...
        <View className='createdGood_details_timeBox'>
          <View className='time_color2'>
            有效期至：{specialGoods.useStartTime} - {specialGoods.useEndTime}
          </View>
        </View>
      </View>)
    }[orderType]
