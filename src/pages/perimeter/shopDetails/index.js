...
class MerchantDetails extends Component{
  ...
  getDetailsById() {
    const {shopDetails:{getGoodsDetail}} = perimeter
    ...
    return(
      <View className='page_shopBox'>
        <View className='shopDetails_banner dakale_nullImage'>
          <Banner
            autoplay={filterStrList(goodsImg||[]).length>1?true:false}
            imgStyle
            data = {filterStrList(goodsImg||[])}
            imgName = {'image'}
          ...
          <View className='shopdetails_priceBox'>
            <View className='shopdetails_left'>
              <View className='shopdetails_setprice'>
                <Text className='shopdetails_bigFont'>¥</Text>{kolPrice || '--'}
                <Text className='shopdetails_lineFont'>¥ {oriPrice || '--'}</Text>
              </View>
              <View className='shopdetails_setbean'>({Number(kolPrice)*100}卡豆）</View>
            </View>
            <View className='shopdetails_right'>
              <View className='shopdetails_priceIcon'>哒卡乐专享价</View>
              <View className='shopdetails_time'>活动截止日期：{activityEndTime||'--'}</View>
            </View>
          </View>
        </View>
        {/*使用商家*/}
        <View className='shopdetails_getShop'>
          <View className='shopdetails_title'>
            {goodsName||'--'}
          </View>
          <View className='shopDetails_tab'>
            ...
            {allowRefund === '1' &&
              <><View className='shopDetails_tab_icon'></View><View className='shopDetails_tab_font'>随时退</View></>
            }
            {allowExpireRefund === '1' &&
             <>
              <View className='shopDetails_tab_icon'></View><View className='shopDetails_tab_font'>过期退</View>
             </>
            }
        ...
        <View className='shopdetails_shop_details'>
          ...
          <View className='shopdetails_Image'></View>
          <View className ='shopdetails_shop_merchantDetails'>
            哒人推荐
          </View>
        ...
        <View className='shopdetails_shop_player'>
          <View className='shopdetails_play_title'>
            使用方法
          </View>
        ...
        <View className='shopdetails_shop_toast'>
          ...
          <View className='shop_toastText'>
            <Text className='shop_toastTextColor'>{useStartTime+ ' - '+useEndTime} </Text>，请在有效期内使用；
          </View>
          <View className='shop_toastDec shop_getDate'>
            使用时间：
          </View>
          <View className='shop_toastText'>
            <Text className='shop_toastTextColor'>每周{useWeek+' '+useTime}</Text>，具体以门店供应时段为准；
          </View>
