...
export default ({ data }) => {
  const { mainImages, logoImg, merchantName, groupName, lat, lnt,address } = data;
  console.log(data);
  return (
    <View class="kaMerchantDetails_bg">
      ...
      <View className="kaMerchantDetails_top_box">
        <View className="kaMerchantDetails_top_content">
          <View
            className="kaMerchantDetails_top_profile"
          ...
          <View className="kaMerchantDetails_top_body">
            ...
            >
              {'附近 ' +merchantName + " | " + GetDistance(getLat(), getLnt(), lat, lnt)}
            </View>
          </View>
        </View>
      </View>
