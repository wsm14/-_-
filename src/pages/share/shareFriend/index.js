...
class Record extends Component {
  ...
  createImg() {
    ...
    upLoadFile(['https://wechat-config.dakale.net/miniprogram/image/shareBackGround1.png']).then(res => {
      const {path} =  res[0]
      _this.setState({
        shareFile: path
      },
        ...
        context.fillText('加入哒卡乐,共赚收益吧!', 10, 418)
