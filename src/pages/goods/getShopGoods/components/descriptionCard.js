  ...
  return (
    <View className='descriptionCard_title'>
      <View className='descriptionCard_box'>
        <View className='descriptionCard_merchant' onClick={() => goMerchant(merchantIdString||merchantId)}>
          <View className='descriptionCard_profile dakale_nullImage' style={merchantImg?backgroundObj(merchantImg):{}}></View>
          <View className='descriptionCard_merchantTitle font_hide'>{merchantName}</View>
        ...
        <View className='descriptionCard_dec'>
          ...
          <View className='descriptionCard_discount discount_top'>
            <View>卡豆抵扣</View>
            <View className='color1'>-{beanFee}(¥ {parseInt(beanFee) / 100}.00)</View>
          </View>
          {/*<View className='descriptionCard_discount discount_top'>*/}
          {/*  <View>优惠券</View>*/}
        ...
        <View className='descriptionCard_payPrice'>
          ...
          <View className='color3 font20'>¥ <Text className='font40 bold'>{payFee.split('.')[0]}</Text><Text className='font28'>{payFee.split('.')[1]&&`.${payFee.split('.')[1]}`}</Text></View>
        </View>
      </View>
    </View>
  )
