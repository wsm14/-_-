  ...
  render() {
    ...
    return (
      <View className='rewardDetails_box'>
        ...
        {visible && <Earn showStatus={current === 0} list={keyValueList[0]}></Earn>}
        {visible && <Expenses showStatus={current === 1} list={keyValueList[1]}></Expenses>}
        {visible && <UserCashTrade showStatus={current === 2} list={keyValueList[2]}></UserCashTrade>}
