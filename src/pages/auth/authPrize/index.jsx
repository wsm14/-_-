...
class Index extends Component {
  ...
  render() {
    return (
      <View className="authPrize_box">
        <View className="authPrize_login">
          <View className="authPrize_title1">恭喜您获得价值</View>
          <View className="authPrize_title2">
            <View className="authPrize_title2_font1">¥</View>
            <View className="authPrize_title2_font2">18.00</View>
          </View>
          <View className="authPrize_title3">新人福利礼包</View>
          <View className="authPrize_title4">超值无门槛 先到先得</View>
          <View className="authPrize_title5">
            <Text className="bold">哒卡乐小程序</Text>
            获得以下授权
          </View>
          <View className="authPrize_title6">
            获取您的手机号，以享受更多优惠
          </View>
          <View className="authPrize_btn">
            <Button
          ...
          <View className="authPrize_bottom color2 font24">
            登录表示您已阅读并同意{" "}
