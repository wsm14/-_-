      ...
      return (
        ...
        >
          ...
          <View className="shareImage_details">
            ...
            {/*//商家详情*/}
            {kolActivityIdString &&
              this.props.store.activeStore.activeStatusObj.kolGoods === "1" && (
                <View className="shareImage_shop_couponBox">
                  ...
                  {/*</View>*/}
                  <View
                    className="image_goshop public_center"
                    onClick={() =>
                      this.link_stop(() =>
                        navigateTo(
                  ...
                  >
                    ...
                    <View className="image_shop_font">
                      <Text className="goods_image_shop font_hide">
                        {goodsName || "--"}
                      </Text>
            ...
            {/*//文章名称*/}
            {this.kolStatus() && topicIdString && topicName && (
              <View
                onClick={() =>
                  Router({
                    routerName: "tipView",
                ...
                className="shareImage_conversation font_hide"
              >
                #{topicName}
              </View>
            )}
